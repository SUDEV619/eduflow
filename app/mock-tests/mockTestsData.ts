...
export type MockTest = {
  ...
  marking: MockTestMarking
}

const makeQuestion = (q: Omit<MockTestQuestion, 'options'> & { options: string[] }): MockTestQuestion => ({
  ...q,
...
export const mockTests: MockTest[] = [
  {
    ...
    durationMinutes: 45,
    difficulty: 'Medium',
    marking: { correctPoints: 1, incorrectPoints: 0, unansweredPoints: 0 },
    questions: [
      makeQuestion({
        id: 'p1',
...
export const getMockTestById = (id: string): MockTest | undefined => mockTests.find((t) => t.id === id)
